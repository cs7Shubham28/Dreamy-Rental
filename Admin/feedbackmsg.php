        ...
        <div class="dashboard">
            ...
            <div class="dashboard-content">
                ...
                <div class="dashboard-title">
                    <h2>Feedback</h2>
                    <h3> <a href="dashboard.php">Dashboard</a> / Feedback</h3>
                </div>
                        ...
                        <table class="user-table">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['search']) && !empty($_GET['search'])) {
                                    $value = $_GET['search'];
                                    $sql = "SELECT * FROM feedback WHERE CONCAT(id, name) LIKE '%$value%'";
                                } else {
                                ...
                                if ($total > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($data)) {
                                        echo "<tr>
                                             ...
                                             <td>" . $row['rating'] . " / 5</td>
                                             <td class='actionbtn'>
                                                 <a href='deletefeedback.php?id=" . $row['id'] . "' class='btn delete'>Delete</a>
                                             </td>
                                         </tr>";
                                    }
                                }
